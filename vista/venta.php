    ...
    <div class="modal-content">
      ...
      <center>
       <table width="80%" border="0" align="center">
         <tr>
           <th colspan="4"id="fact_aling"><h4>Inversiones Sky Blue R.B</h4></th>
         </tr>
         <tr>
         <th colspan="4"id="fact_aling">Calle Raul leonis II el Amparo edo apure </th>
            </tr>

            <tr>
              <td ><b>Fecha:</b><?php echo  "&nbsp;&nbsp;".$fecha; ?></td>
               <td colspan="2"> <b>Factura:</b> SB-<?php require '../require/numFactura.php'; ?></td>
            </tr>
...
while($fact=$stm->fetch_array()) {  ?>
              ...
              <td><?php  echo $fact['nombre_pro']?></td>
                <td><?php  echo "X&nbsp;".$fact['cantidad']?></td>
                 <td><?php  echo "Bs&nbsp;&nbsp;".$fact['precio']?></td>
                  <td><?php echo "Bs&nbsp;&nbsp;".$fact['total']  ?></td>
               </tr>
        <?php  }  ?>
                <tr>
                 ...
                 <tr>
              <td><b>BI G</b> (12,00%)</td>
                <td colspan="3"id="aling_right" >  <?php echo "Bs&nbsp;&nbsp;".$SubTotal; ?></td>
                ...
                <tr>
              <td><b>IVA G</b> (12,00%)</td>
                <td colspan="3" id="aling_right"><b></b>  <?php echo "Bs&nbsp;&nbsp;".$Iva ?></td>
               </tr>
              ...
              <td colspan="4"><center><b>-----------------------------------------------------------------------------------------------</b></center></td>
               ...
               <tr>
              <td><h4>TOTAL</h4></td>
                <td colspan="3" id="aling_right"><h4>Bs<?php echo "&nbsp;&nbsp;".$total; ?> </h4></td>
               </tr>
