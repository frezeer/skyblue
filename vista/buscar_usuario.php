...
if (isset($_GET['Eliminar_emp'])) {
   ...
   header("location:../controlador/Controlador.php?id=$id&status=eliminado&Eliminar_emp");
 }
...
<html lang="en">
  ...
  <script type="text/javascript" src="../js/ajax_empleado.js"></script>
...
if ($status=="activo") {
 ...
 <td id="table_operaciones"><?php echo '  <a href="ver_empleado.php?id='.$fila[0].'" id="bold" class="btn btn-default btn-xs"> <span class="glyphicon glyphicon-eye-open"></span>&nbsp;Ver</a>';?></td>
  <td id="table_operaciones"><?php echo '  <a href="modificar_empleado.php?id='.$fila[0].'" id="bold" class="btn btn-info btn-xs"> <span class="glyphicon glyphicon-edit"></span>&nbsp;Editar</a>';?></td>
 <td id="table_operaciones"><?php echo ' <a href="buscar_usuario.php?id='.$fila[0].'&status=eliminado&Eliminar_emp" id="bold" class="btn btn-danger btn-xs"> <span class="glyphicon glyphicon-edit"></span>&nbsp;Eliminar</a>';?></td>
</tr>
  <?php 
}
     ?>
